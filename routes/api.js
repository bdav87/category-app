...
const CreateAPI = require('../lib/helpers/CreateAPI');
...
router.post('/import', upload.single('csvFile'), (req, res) => {
    ...
    function prepareCategories(data) {
        const newCategory = {
            ...
            'is_visible': BoolString.YesNoToBoolean(data['Category Visible']) || true,
        ...
        if (data['Category URL'] && data['Custom URL']) {
            newCategory['custom_url'] = {
                ...
                'is_customized': BoolString.YesNoToBoolean(data['Custom URL'])
            };
        }
